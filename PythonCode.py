...
def main():
    ...
    def clean_text(text):
        ...
        unwanted_words = {'ca', 'w3w5xd', 'seit', 'zb','z','b','e','nr'} 
    ...
    def run_lda_analysis(text_list, num_topics):
        # Erstellen eines Gensim Dictionary
        dictionary = corpora.Dictionary(text_list)  

        # Erstellen eines Gensim Corpus
    ...
    # Für 'Betreff' ausführen
    lda_model_betreff, coherence_betreff = run_lda_analysis(cleaned_betreff_liste, 5)

    # Für 'Sachverhalt' ausführen
    lda_model_sachverhalt, coherence_sachverhalt = run_lda_analysis(cleaned_sachverhalt_liste, 7)
    ...
    """
    ######## Zur visuellen Ausgabe in jupyter Notebook
    #Gensim
    import gensim
    ...
    perform_lda(sachverhalt_strings, 7)
